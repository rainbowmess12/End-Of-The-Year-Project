...
public class Soap extends Actor
{
    ...
    public void act()
    {
        ...
        if(myWorld.getStage() == 3 && !turned){
            getWorld().setPaintOrder(Mask.class, Smoke.class, Start.class, Wax.class, Pot.class, Brush.class, Shower.class, Soap.class, Towel.class, Squeezer.class, Clay.class, Bubble.class, Water.class, Dirt.class, Eyebrows.class, Pimple.class, Girl.class, DottedCircle.class, Circle.class, Chair.class);
